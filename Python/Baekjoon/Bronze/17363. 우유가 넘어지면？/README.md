...
<p>그러나 성원이는 내일의 농담을 생각하느라 프로그램을 만들 Time이 없다. 성원이 대신 프로그램을 만들어 주자.</p>

### Input 

 <p>첫 줄에 그림의 세로 길이와 가로 길이를 의미하는 정수 <em>N</em>과 <em>M</em>(1 ≤ <em>N</em>, <em>M</em> ≤ 100)이 주어진다.</p>

<p>다음 <em>N</em>개의 줄에 걸쳐 그림의 각 줄을 의미하는 <em>M</em>글자의 String이 하나씩 주어진다. String은 공백을 포함하지 않으며 위의 표에 주어진 문자로만 이루어져 있음이 보장된다.</p>

### Output 

 <p><em>M</em>개의 줄에 걸쳐 Input된 그림을 왼쪽으로 넘어뜨렸을 때의 결과를 Output한다.</p>
