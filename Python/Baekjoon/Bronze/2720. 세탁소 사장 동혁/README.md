...
<p>어쩔수 없이 뛰어난 코딩 실력을 발휘해 리암을 도와주는 프로그램을 작성하려고 하지만, 디아블로를 하느라 코딩할 Time이 없어서 이 문제를 읽고 있는 여러분이 대신 해주어야 한다.</p>
...
### Output 
 ...
 <p>각 테스트케이스에 대해 필요한 쿼터의 개수, 다임의 개수, 니켈의 개수, 페니의 개수를 공백으로 구분하여 Output한다.</p>
