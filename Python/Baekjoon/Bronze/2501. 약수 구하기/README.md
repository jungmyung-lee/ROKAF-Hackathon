...
<p>두 개의 자연수 N과 K가 주어졌을 때, N의 약수들 중 K번째로 작은 수를 Output하는 프로그램을 작성하시오.</p>
...
### Output 
 ...
 <p>첫째 줄에 N의 약수들 중 K번째로 작은 수를 Output한다. 만일 N의 약수의 개수가 K개보다 적어서 K번째 약수가 존재하지 않을 경우에는 0을 Output하시오.</p>
