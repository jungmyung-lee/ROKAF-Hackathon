...
### Input 
 ...
 <p>Input은 총 28줄로 각 제출자(학생)의 출석번호 n(1 ≤ n ≤ 30)가 한 줄에 하나씩 주어진다. 출석번호에 중복은 없다.</p>

### Output 

 <p>Output은 2줄이다. 1번째 줄엔 제출하지 않은 학생의 출석번호 중 가장 작은 것을 Output하고, 2번째 줄에선 그 다음 출석번호를 Output한다.</p>
