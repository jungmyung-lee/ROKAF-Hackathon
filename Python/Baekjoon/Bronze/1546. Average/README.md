...
<p>예를 들어, 세준이의 최고점이 70이고, Mathematics점수가 50이었으면 Mathematics점수는 50/70*100이 되어 71.43점이 된다.</p>
...
### Output 
 ...
 <p>첫째 줄에 새로운 평균을 Output한다. 실제 정답과 Output값의 절대오차 또는 상대오차가 10<sup>-2</sup> 이하이면 정답이다.</p>
